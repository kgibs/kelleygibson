    ...
    class UploadHandler
    {
        ...
        function __construct($options = null, $initialize = true, $error_messages = null) {
            ...
            $this->options = array(
                ...
                'script_url' => admin_url('admin-ajax.php').'?action=consultant_profile_image',
                'upload_dir' => $obj_upload_dir['basedir'].'/profile-pics/',
                'upload_url' => $obj_upload_dir['baseurl'].'/profile-pics/',
                'user_dirs' => false,
                'mkdir_mode' => 0755,
                'param_name' => 'files',
                ...
                'image_versions' => array(
                    ...
                    // uploaded images:
                    '' => array(
                        'max_width' => $_wp_additional_image_sizes['consultant-large']['width'],
                        'max_height' => $_wp_additional_image_sizes['consultant-large']['height'],
                        'jpeg_quality' => 90
                    ),
                    ...
                    */
                    'thumbnail' => array(
                        ...
                        //'crop' => true,
                        'max_width' => $_wp_additional_image_sizes['post-thumbnail']['width'],
                        'max_height' => $_wp_additional_image_sizes['post-thumbnail']['height']
                    )
                )
            );
            if ($options) {
        ...
        protected function get_file_size($file_path, $clear_stat_cache = false) {
            if ($clear_stat_cache) {
                $ref = new ReflectionFunction('clearstatcache');
                if ($ref->getNumberOfParameters() > 0) // 2 Parameters only works in PHP 5.3+
        ...
        protected function generate_response($content, $print_response = true) {
            if ($print_response) {
                $json = strip_tags(json_encode($content));
